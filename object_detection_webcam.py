...
#car3.setLocationChangeCallback(locationChangeCallback) # Set location change callback to function above
#print(car3.piece)
#car3.changeSpeed(500, 1000) # Set car speed with speed = 500, acceleration = 1000
